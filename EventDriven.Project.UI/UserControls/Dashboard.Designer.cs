namespace EventDriven.Project.UI.UserControls
{
    partial class Dashboard
    {
        ...
        private void InitializeComponent()
        {
            ...
            panelRooms = new EventDriven.Project.UI.CustomControls.CustomPanel();
            lblRoomCount = new Label();
            label8 = new Label();
            pictureRooms = new PictureBox();
            panelPatients = new EventDriven.Project.UI.CustomControls.CustomPanel();
            lblPatientCount = new Label();
            label6 = new Label();
            picturePatients = new PictureBox();
            panelNurses = new EventDriven.Project.UI.CustomControls.CustomPanel();
            lblNursesCount = new Label();
            label4 = new Label();
            pictureNurses = new PictureBox();
            panelDoctors = new EventDriven.Project.UI.CustomControls.CustomPanel();
